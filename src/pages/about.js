...
export default class About extends React.Component {
  ...
  render() {
    ...
    return (
        <Layout>
        <SEO title="About" description="Where to work is a collection of spaces to work online as a digital nomad or online worker in Belfast, Dublin and London. Find fast wifi speeds and quiet places to work." />
        ...
        <ContentWrapper>
            <h2>Wtf is this?</h2>
            <p>Where to work is a collection of spaces to work online as a digital nomad or online worker in Belfast, Dublin and London (with more cities coming).</p>
